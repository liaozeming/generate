...
public class MpGeneratorUtil {
    ...
    private static String[] TABLENAME = {"dept"};

    //作者信息，会自动添加到文件内
    private static String AUTHOR = "lzm";

    //数据库连接
    private static String DRIVENAME = "com.mysql.cj.jdbc.Driver";                   //驱动，如果版本低于8.0，首先需要更换jar包，此处使用com.mysql.jdbc.Driver
    private static String DATABASE = "jdbc:mysql://localhost:3306/db01?useUnicode=true&characterEncoding=UTF-8&serverTimezone=UTC";       //数据库连接url
    ...
    private static String PARENT_PACKAGE = "com.lzm";            //基础包
    ...
    private static String XML_FOLERNAME = "mapper";              //XML文件
